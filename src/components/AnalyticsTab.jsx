...
export const AnalyticsTab = () => {
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="glass-panel-gold rounded-2xl p-6 border border-gold-500/30 shadow-xl space-y-6">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">
                Real-time performance analytics compiled across Tasmee & Ikhtebaar modules
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 text-center">
            <span className="block text-[10px] text-slate-400 font-semibold uppercase">Total Recitations</span>
          ...
          <div className="p-4 rounded-xl bg-amber-950/50 border border-amber-500/30 text-center">
            <span className="block text-[10px] text-amber-400 font-semibold uppercase">Mutashabihat Words</span>
      ...
      <div className="glass-panel rounded-2xl p-6 border border-gold-500/20 shadow-xl space-y-4">
        <div className="flex items-center justify-between border-b border-slate-800 pb-3">
          <h3 className="font-bold text-slate-100 text-sm flex items-center gap-2">
            <Layers className="w-4 h-4 text-gold-400" /> 30-Juz Memorization Heatmap Matrix
          </h3>
      ...
      {/* 3. Frequent Mistakes Queue (Mutashabihat) */}
      <div className="glass-panel-gold rounded-2xl p-6 border border-gold-500/30 shadow-xl space-y-4">
        <div className="flex items-center justify-between border-b border-slate-800 pb-3">
          <div>
            <h3 className="font-bold text-slate-100 text-sm flex items-center gap-2">
              <AlertCircle className="w-4 h-4 text-amber-400" /> Mutashabihat & Revision Queue (Frequent Mistakes)
            </h3>
            <p className="text-xs text-slate-400 mt-0.5">
              Specific Arabic words flagged multiple times during Tasmee & Ikhtebaar recitations
            </p>
          </div>
        </div>
        ...
        {frequent_mistakes.length === 0 ? (
          <div className="p-8 text-center bg-slate-950 rounded-xl border border-slate-800 text-slate-400 text-xs">
            ...
            <p className="mt-1">Keep reciting in Tasmee mode to log your evaluation history.</p>
          </div>
        ) : (
      ...
      <div className="glass-panel rounded-2xl p-6 border border-gold-500/20 shadow-xl space-y-4">
        <h3 className="font-bold text-slate-100 text-sm flex items-center gap-2 border-b border-slate-800 pb-3">
          <Clock className="w-4 h-4 text-gold-400" /> Recent Recitation Evaluation Logs
        </h3>
